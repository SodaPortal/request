<template>
  <div class="navbar">
    <img src="/arrow-right-solid.svg" alt="send-request" @click="store.store.commit('setRequestState', 0)" />
    <img src="/arrow-left-solid.svg" alt="response" @click="store.store.commit('setRequestState', 1)" />
    <img src="/code-solid.svg" alt="code" @click="store.store.commit('setRequestState', 2)" />
  </div>
