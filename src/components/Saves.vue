<template>
  <div class="align-flex">
    ...
    <div class="saves">
      <span>
        <input type="text" placeholder="Filter Name or Methods" v-model="filter" @keyup.enter="updateFilter" />
...
function loadJson() {
  invoke("read_json_file", { folder: currentFolder.value }).then((response: any) => {
