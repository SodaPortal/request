<template>
  <div class="request">
    ...
    <span>
      <select data-selected @change="(e: any) => store.store.commit('setMethod', e.target.value)" :value="method">
      ...
      <input type="text" placeholder="http://localhost:5173/" @input="(e: any) => store.store.commit('setUrl', e.target.value)" @keyup.enter="sendRequest" :value="url" />
...
import { generateRequestFormat, generateSaveFormat } from "../helpers/objectFormatter";
