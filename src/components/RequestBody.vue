<template>
  <span>
    <p>Edit Mode</p>
    <select data-selected @change="(e: any) => store.store.commit('setBodyType', e.target.value)" :value="bodyType">
...
onMounted(() => {
  ...
  aceBody.addEventListener("input", () => store.store.commit("setBody", aceBody.getValue()));
